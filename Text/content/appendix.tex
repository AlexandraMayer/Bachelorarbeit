...
\begin{sidewaystable}[h!]
	...
	\begin{tabular}{|p{1 cm} p{1.3 cm} p{1.2 cm} p{1.2 cm} p{1.2 cm} p{1.9 cm} p{1.9 cm} p{2.2 cm} p{1 cm} p{1 cm}|}
		...
		\hline
	\end{tabular}
	\caption{Fahrgastwechselzeiten Tabelle: Zusatzmaterial \textsl{Times.csv}. Quelle: Eigene Tabelle.}
	\label{tab:times}
\end{sidewaystable}
\clearpage
...
\begin{sidewaystable}[h!]
	...
	\begin{tabular}{|p{1.05 cm} p{1.5 cm} p{2.7 cm} p{2.5 cm} p{2 cm} p{1 cm} p{0.7 cm} p{1.7 cm} p{1.5 cm} p{1.2 cm}|}
		...
		\hline
	\end{tabular}
	\caption{Verhaltenstabelle: Zusatzmaterial \textsl{Behaviors.csv} Quelle: Eigene Tabelle.}
	\label{tab:Vehalten}
\end{sidewaystable}
\clearpage
